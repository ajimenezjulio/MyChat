...
// We need a delegate (so create a protocol) to notify from our cell to the UsersTableViewController when the avatarImage is pressed.
...
class UserTableViewCell: UITableViewCell {
    ...
    // Required the @objc when using selectors
    @objc func avatarTap() {
        // Notify to the delegate
